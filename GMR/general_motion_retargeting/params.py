...
ROBOT_XML_DICT = {
    ...
    "pi_plus_waist": ASSET_ROOT / "pi_plus_23dof_251103" / "xml" / "pi_plus_23dof_251103.xml",     #   1自由度腰 5自由度手臂(含手腕)
    "pi_plus_head": ASSET_ROOT / "pi_plus_24dof_250826" / "xml" / "pi_24dof_1215.xml",     #   2自由度头部 5自由度手臂(含手腕)
    "pi_plus": ASSET_ROOT / "pi_plus_24dof_250826" / "xml" / "pi_plus_22dof_1218.xml",   #  2自由度头部 1自由度腰 5自由度手臂(含手腕)
    "pi": ASSET_ROOT / "pi_12dof_1222" / "xml" / "pi_12dof.xml",     #  12自由度 只有腿部
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "pi_plus_waist": IK_CONFIG_ROOT / "smplx_to_pi_plus_waist.json",
        "pi_plus_head": IK_CONFIG_ROOT / "smplx_to_pi_plus_head.json",
        "pi_plus": IK_CONFIG_ROOT / "smplx_to_pi_plus.json",
        "pi": IK_CONFIG_ROOT / "smplx_to_pi.json"
    },
    "bvh":{
        ...
        # "pi_football": IK_CONFIG_ROOT / "bvh_to_pi_football_shanghai.json",
        "pi_plus_waist": IK_CONFIG_ROOT / "bvh_to_pi_plus_waist.json",
        "pi_plus_head": IK_CONFIG_ROOT / "bvh_to_pi_plus_head.json",
        # "pi_plus": IK_CONFIG_ROOT / "bvh_to_pi_plus.json",
        "pi_plus": IK_CONFIG_ROOT / "bvh_to_pi_football_shanghai.json",
        "pi": IK_CONFIG_ROOT / "bvh_to_pi.json",
...
ROBOT_BASE_DICT = {
    ...
    "pi_plus_waist": "base_link",
    "pi_plus_head": "base_link",
    "pi_plus": "base_link",
    "pi": "base_link"
}
